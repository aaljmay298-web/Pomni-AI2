...
const client = new Client({
  phoneNumber: '966592271563', // Bot number
  prefix: [".", "/", "!"],
  fromMe: false, 
  owners: [
  // Owner 1
    { name: "VA", lid: "966592271563@lid", jid: "972569311531@s.whatsapp.net" },
  // Owner 2
    { name: "emam", lid: "966592271563@lid", jid: "201144480436@s.whatsapp.net" },
  // Owner 3
